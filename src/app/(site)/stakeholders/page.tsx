...
export default function StakeholdersPage() {
  return (
    <>
      ...
      <section id="board" className="scroll-mt-24 border-b border-hairline bg-surface">
                ...
                <li key={body.name} className="flex flex-col gap-4 py-5">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <a
                      ...
                      className="w-fit text-body text-fg underline decoration-hairline underline-offset-4 transition-colors hover:text-accent hover:decoration-current focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
                    >
                      {body.name}
